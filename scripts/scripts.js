...
var SwitchModel = document.getElementById("Switch-Model-button");
...
var AdjustDuration = document.getElementById("Change-Duration-button");
...
function changeDuration() {
	...
	if (NewDuration) {
		...
		alert("Invalid, Please enter a duration");
	}
}
AdjustDuration.addEventListener("click", changeDuration);